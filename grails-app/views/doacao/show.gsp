...
<html>
    ...
    <body>
        ...
        <div id="show-doacao" class="content scaffold-show" role="main">
            ...
            <f:display bean="doacao" />
            <g:form resource="${this.doacao}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.doacao}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

...
<html>
    ...
    <body>
        ...
        <div id="show-resenha" class="content scaffold-show" role="main">
            ...
            <f:display bean="resenha" />
            <g:form resource="${this.resenha}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.resenha}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
